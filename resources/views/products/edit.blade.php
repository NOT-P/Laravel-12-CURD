            ...
            <div class="card-body shadow-lg">
              <form action="{{ route('products.update',$product->id) }}" enctype="multipart/form-data" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('name',$product->name) }}" type="text" class="form-control @error('name') is-invalid
                ...
                <div class="mb-3">
                    ...
                    @if (!empty($product->image))
                            <img class="rounded mt-3" src="{{ asset('uploads/products/'.$product->image) }}" width="150" alt="">
                     @endif   
                </div>

                <div class="mb-3">
                    <label for="sku" class="form-label">SKU</label>
                    <input  value="{{ old('sku',$product->sku) }}"type="text" class="form-control @error('image') is-invalid
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old(key: 'price') }}" type="text" class="form-control @error('image') is-invalid
